...
function (_Component) {
  ...
  function CreateInjuryModal(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleBranchChange", function (e, index) {
      console.log(e);
      console.log(index);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleBodyChange", function (e, _ref4) {
      var name = _ref4.name,
          value = _ref4.value;
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSinusChange", function (e, _ref5) {
      var name = _ref5.name,
          value = _ref5.value;
...
//# sourceMappingURL=main.js.9d8264e42afb493495ab.hot-update.js.map